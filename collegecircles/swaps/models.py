...
class Offer(models.Model):
    ...
    short_description = models.CharField(_('title'), max_length=64)
    offering = models.TextField(_('I offer'))
    want = models.TextField(_('description'), blank=True, null=True)
    ...
    acceptor = models.ForeignKey(User, related_name='acceptor', verbose_name=_('acceptor'), blank=True, null=True)

    acceptors = models.ManyToManyField(User,
        related_name = "swaps",
        verbose_name = _("acceptors"),
    )


    # circle = models.ForeignKey(Tribe, blank=True, null=True)
    circles = models.ManyToManyField(Tribe,
        related_name = "swaps",
...
class Swap(models.Model):
    ...
    def __unicode__(self):
        ...
        } + str(self.proposing_offer.offerer) + ' : ' + str(self.responding_offer.offerer)
    ...
    def _save_(self, pro_off, resp_off):
        self.state = 3
        self.proposing_offer = pro_off
        self.responding_offer = resp_off
